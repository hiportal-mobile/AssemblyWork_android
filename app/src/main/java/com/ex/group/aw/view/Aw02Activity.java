 ...
 */
@SuppressLint("NewApi")
public class Aw02Activity extends Activity implements OnClickListener {

	private final String LOGTAG = "Aw02Activity";
	WebView webview;
...
//		user_id = "21714624";//테스트 testN02145
		webview.loadUrl( "http://128.200.121.68:9000/emp_ex/service.pe?primitive=AW_MO_ASSEMMBRLIST");//운영
	}
...
//					DzImageViewer(file_name ,file_path);
					DocuzenViewLauncher((Activity)Aw02Activity.this, file_name ,file_path);
				}
	        }
...
//	문서뷰어 연동 
	public void DzImageViewer(String fileName ,String filePath){
		...
		Intent intent = new Intent(Aw02Activity.this, handyhis.dz.viewer.DzImageViewer.DzImageViewer.class);
...
//	   toiphoneapp://callDocumentFunction?fileName=1569902914382.hwp&filePath=\\192.168.53.10//EAI_FILE7/aams/request/hwp/201909/
	...
	public void onBackPressed() {
		...
		if(click_url.indexOf("ASSEMMBRLIST") > -1){
