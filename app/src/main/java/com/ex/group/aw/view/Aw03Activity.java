...
/*
	...
	VERSION: 0.1
 */
public class Aw03Activity extends Activity
{
...
//				);
	...
	public  void setData(){
		...
		dbOpenHelper = new DatabaseOpenHelper(Aw03Activity.this);
		dbOpenHelper.open();
...
//				}
	...
	public void getAssemList(){
		...
		{
			mDlgNetwork = ProgressDialog.show(Aw03Activity.this, "모바일 국회", "데이터 검색중입니다.");
		}
